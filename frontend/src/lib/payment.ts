...
import { STRIPE_PUBLISHABLE_KEY, STRIPE_PRICE_IDS, API_ENDPOINTS } from './stripe';
...
export const redirectToCheckout = async (
  ...
  try {
    ...
    if (!priceId || priceId.includes('xxx')) {
      throw new Error('Stripe Price ID not configured. Please set up your Stripe products first.');
    }
