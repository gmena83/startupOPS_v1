        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight">
              ...
              <span className="text-accent">{t("hero.title").split(" ").slice(2).join(" ")}</span>
            </h1>
            ...
            <div className="grid grid-cols-2 sm:flex sm:items-center gap-4 sm:gap-8 pt-4">
              <div>
                <p className="text-2xl sm:text-3xl font-bold">{t("hero.stat1.value")}</p>
                <p className="text-xs sm:text-sm text-muted-foreground">{t("hero.stat1.label")}</p>
              </div>
              <div className="hidden sm:block h-12 w-px bg-border" />
              <div>
                <p className="text-2xl sm:text-3xl font-bold">{t("hero.stat2.value")}</p>
                <p className="text-xs sm:text-sm text-muted-foreground">{t("hero.stat2.label")}</p>
              </div>
              <div className="hidden sm:block h-12 w-px bg-border" />
              <div className="col-span-2 sm:col-span-1">
                <p className="text-2xl sm:text-3xl font-bold">{t("hero.stat3.value")}</p>
          ...
          <div className="relative animate-fade-in">
            ...
            <div className="hidden sm:block absolute -bottom-6 -left-6 bg-card p-4 sm:p-6 rounded-xl shadow-large border border-border animate-scale-in">
              <p className="text-xs sm:text-sm text-muted-foreground mb-1">Monthly Time Saved</p>
              <p className="text-2xl sm:text-3xl font-bold text-accent">156 hours</p>
            </div>
          </div>
        </div>
      </div>
