...
const features = [
  { icon: Zap, titleKey: "features.1.title", descKey: "features.1.description" },
  { icon: Workflow, titleKey: "features.2.title", descKey: "features.2.description" },
  { icon: Clock, titleKey: "features.3.title", descKey: "features.3.description" },
  { icon: BarChart3, titleKey: "features.4.title", descKey: "features.4.description" },
  { icon: Shield, titleKey: "features.5.title", descKey: "features.5.description" },
  { icon: HeadphonesIcon, titleKey: "features.6.title", descKey: "features.6.description" },
];
